...
<head>
    <head>
        ...
        <meta name="description" content="<?php echo $site['name']; ?> - Es un servidor privado Nostale que tiene como objetivo proporcionarle contenido nuevo que ningún otro servidor ha ofrecido.">
        <meta name="keywords" content="Oldstale, servidor privado de nostale">
        ...
        <script src="./scripts/script_1.js" charset="utf-8"></script>
    </head>
    ...
    <div class="nk-contacts-top">
        <div class="container">
            ...
            <div class="nk-contacts-left">
                ...
                <div class="idioma">
                    <button class="translate" id="es"> <img src="../../images/es.png"></button>
                    <button class="translate" id="en"> <img src="../../images/en.png"></button>
                    <button class="translate" id="fr"> <img src="../../images/fr.png"></button>
                </div>
                    ...
                    <?php if (isset($lsu_Eingeloggt) && $lsu_Eingeloggt == 0): ?>
                        <li>
                            <a href="#" data-toggle="modal" data-target="#modalRegister">
                                <head-text class="lang" key="Register">REGISTER</head-text><span class="fa fa-user-plus"></span>
                            </a>
                        </li>
                        <li>
                            <a href="#" data-toggle="modal" data-target="#modalLogin">
                                <head-text class="Entrar">LOG IN</head-text><span class="fa fa-user"></span>
                            </a>
                        </li>
                    <?php else: 
                        ...
                        <li>
                            ...
                            <div class="nk-cart-dropdown">
                                ...
                                <div class="nk-widget-post" style="margin-top:5px;">
                                    ...
                                    <a href="news/index/adminpanel.php" class="lang nk-btn nk-btn-rounded nk-btn-color-main-1 nk-btn-hover-color-white" style="float:left;margin-left:-15px;margin-top:5px;" key="Panel">Panel Administrative</a>
                                    <!-- Show that if the authority is > 1 -->
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="/user/logout.php">
                                <head-text class="Salir">Se déconnecter</head-text><span class="fa fa-sign-out"></span>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
...
<div class="nk-main">
    ...
    <div class="container">
        <ul class="nk-breadcrumbs">
            ...
            <li><a href="/index" class="lang" key="Home">HOME</a></li>


            <li><span class="fa fa-angle-right"></span></li>

            <li><span class="lang" key="Panel">PANEL ADMIN</span></li>
        ...
        <div class="nk-accordion" id="accordion-1" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="accordion-1-1-heading">
                    <a class="collapsed lang" data-toggle="collapse" data-parent="#accordion-1" href="#accordion-1-1" aria-expanded="true" aria-controls="accordion-1-1" key="InfoP">
                       Player Information<span class="panel-heading-arrow fa fa-angle-down"></span>
                    </a>
                </div>
                <div id="accordion-1-1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="accordion-1-1-heading">
                    <form action="adminpanel.php" method="post" class="nk-form nk-form-style-1">
                        <div class="input-group">
                            <input type="text" name="PlayerName" class="form-control" placeholder="Find a player (Character Name)">
                    ...
                    ?>
                        <table class="nk-table">
                            <thead>
                                <tr>
                                    <th colspan="3" class="lang" key="InfoP">Player Information <?= $CharacterTable["Name"] ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td clas="lang" key="AccID">Account ID</td>
                                    <td><?= $CharacterTable["AccountId"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="CharID">Character ID</td>
                                    <td><?= $CharacterTable["CharacterId"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="IP">Adresse IP</td>
                                    <td><?= $AccountTable["RegistrationIP"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="Coins">Coins</td>
                                    <td><?= $CoinsDreamTrixTable["Coins"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="Nick">Nickname</td>
                                    <td><?= $CharacterTable["Name"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="class">Class</td>
                                    <td><?= $CharacterTable["Class"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="CombatL">Combat level</td>
                                    <td><?= $CharacterTable["Level"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="JobL">Job level</td>
                                    <td><?= $CharacterTable["JobLevel"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="Dignity">Dignity</td>
                                    <td><?= $CharacterTable["Dignity"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="Reput">Réputation</td>
                                    <td><?= $CharacterTable["Reputation"] ?></td>
                                </tr>
                                <tr>
                                    <td class="lang" key="Gold">Gold</td>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="accordion-1-2-heading">
                    <a class="collapsed lang" data-toggle="collapse" data-parent="#accordion-1" href="#accordion-1-2" aria-expanded="true" aria-controls="accordion-1-2" key="InfoNs">
                        Information on the NosBazar <span class="panel-heading-arrow fa fa-angle-down"></span>
                    </a>
                </div>
                <div id="accordion-1-2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="accordion-1-2-heading">
                    <form action="adminpanel.php" method="post" class="nk-form nk-form-style-1">
                        <div class="input-group">
                            <input type="text" name="PlayerCharacterId" class="form-control" placeholder="Find a player (CharacterId)">
                    ...
                    <table class="nk-table">
                        <thead>
                            <tr>
                                <th colspan="4" class="lang" key="InfoNs1">Information from NosBazaar from <?= $CharacterTable["Name"] ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th class="lang" key="ObjName">Object name</th>
                                <th clas="lang" key="DatExp">Date expiration</th>
                                <th class="lang" key="Price">Price</th>
                                <th class="lang" key="Img">Image</th>
                            </tr>
                            <?php
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="accordion-1-3-heading">
                    <a class="collapsed lang" data-toggle="collapse" data-parent="#accordion-1" href="#accordion-1-3" aria-expanded="true" aria-controls="accordion-1-3" key="CoinsM">
                        Coins Manager <span class="panel-heading-arrow fa fa-angle-down"></span>
                    </a>
                </div>
                    ...
                    <form method="POST" action="PlayerCoins.php" class="nk-form">
                        <div class="row vertical-gap">
                            <div class="col-lg-6">
                                ...
                                <label for="lname" class="lang" key="PAccID">Player AccountId<span class="text-main-2"></span></label>
                                <input type="text" class="form-control required" name="AccountId" id="lname">

                                <div class="nk-gap-1"></div>
                                <label for="company" class="lang" key="AddC">Add Coins</label>
                                <input type="text" class="form-control" name="AddCoins" id="company">

                                <div class="nk-gap-1"></div>
                                <label for="company" class="lang" key="RemC">Remove coins</label>
                                <input type="text" class="form-control" name="RemoveCoins" id="company">
                                <div class="nk-gap-1"></div>
                                <button type="submit" class="nk-btn nk-btn-xs nk-btn-rounded nk-btn-color-white lang" key="Apply">Apply</button>
                            </div>
                        </div>
