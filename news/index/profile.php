            ...
            <?php if (isset($lsu_Eingeloggt) && $lsu_Eingeloggt == 0): ?>
              ...
              <li>
                <a href="#" data-toggle="modal" data-target="#modalLogin">
                  <head-text class="lang" key="Salir">LOG IN</head-text><span class="fa fa-user"></span>
                </a>
              </li>
            <?php else: 
              ...
              <li>
                ...
                <div class="nk-cart-dropdown">
                  ...
                  <div class="nk-widget-post" style="margin-top:5px;">
                    ...
                    <h3 class="nk-post-title lang" style="margin-left:-15px;margin-top:10px;margin-bottom:10px;" key="Buenos">Good morning, <username-color><?php echo $_SESSION["User"]; ?></username-color>.</h3>
                    <h3 class="nk-post-title lang" style="margin-left:-15px;margin-top:10px;margin-bottom:10px;" key="tienes">you have : <?= $result["Coins"] ?> coins.</h3>
                    <a href="/profile/<?php echo $myUser['Name']; ?>" class="nk-btn nk-btn-rounded nk-btn-color-main-1 nk-btn-hover-color-white lang" style="float:left;margin-left:-15px;margin-top:5px;" key="ViewP">View profile</a>
              ...
              <li>
                <a href="/user/logout.php">
                  <head-text class="Salir">LOG OUT</head-text><span class="fa fa-sign-out"></span>
                </a>
              </li>
            <?php endif; ?>
          </ul>
    ...
    <div class="nk-main">
      ...
      <div class="container">
        <ul class="nk-breadcrumbs">
          <li>
            <a href="/index" class="lang" key="Home">Accueil</a>
          </li>
          <li>
                    ...
                    <div class="nk-widget-match" style="margin-bottom: -12px;background-color: #dd163b;">
                      <a href="/profile/Athena" style="width:100%;">
                        ...
                        <span class="nk-widget-match-right" style="float:right;margin-top:10px;">
                          <span class="nk-match-score lang" style="background-color: #fff;color:#141718;" key="ViewP">View Profile</span>
                        </span>
                      </a>
                    </div>
