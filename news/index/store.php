...
<head>
    ...
    <!-- call/:scripts -->
    <link rel="stylesheet" type="text/css" href="assets/css/botons.css">
...
<!-- END : Navbar -->
            ...
            ?>
            	...
            	<div class="row vertical-gap">
                    <div class="col-md-6 col-lg-4">
                            ...
                            ?>
                                    <button id="Pack1" style="position: absolute;
    display: flex;
    align-items: center;
    ...
    padding-right: 30px;
    margin-right: 30px;
    margin-left: 30px;" class="nk-btn nk-btn-rounded nk-btn-color-main-1">Récupérer</button>
                            <?php
                                endif;
                            ?>
                    </div>  
                    <div class="col-md-6 col-lg-4 order-lg-3">
                            <div class="nk-gallery-item-box">
                                <a href="#" class="nk-gallery-item">                                 <img src="assets/images/PSD_Familier.jpg" alt="However, I have reason" style="position: relative;">
                                </a>
                                <div class="nk-gallery-item-label">
                                    <h4 class="mb-0">Roulette</h4>
                                </div>
                            </div>
                            <button class="boton colorBoton formaBoton" href="#Aqui URL">PRESIONAME!</button> 
            ...
            $(document).ready(function() {
                $("#Pack2").on('click', function() {
                    if($("#SelectPerso2 option:selected").val() === ""){ 
                        alert("Character field cannot be null!");
                        return;
                    }
