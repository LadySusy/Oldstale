		...
		<div class="nk-nav-table">
			<ul class="nk-nav nk-nav-right hidden-md-down" data-nav-mobile="#nk-nav-mobile">
				<li class=" nk-drop-item">
					<li>
						<a href=/index class="lang"key="Home">Home</a>
					</li>
					<?php if(!empty($_SESSION["User"])): ?>
						<li class=" nk-drop-item">
							<a href="/news/index/store.php" class="lang"key="Shop">Shop</a>
							<ul class="dropdown">
								<li>
									<li class="nk-drop-item">
										...
										<ul class="dropdown">
											<li>
												...
												<a href="/news/index/stripe.php" class="lang"key="Banco">Bank card</a>
												<a href="/news/index/dedipass.php" class="lang"key="SMS">Telephone / SMS</a>
											</li>
										</ul>
									</li>
									<li class="nk-drop-item">
										<a href="/news/index/store.php" class="lang"key="Categorias">Category</a>
										<ul class="dropdown">
											<?php 
						...
						<?php endif; ?>
						<li>
							<a href="<?php echo $Board; ?>" target="blank" class="lang"key="Forum">Forum</a>
						</li>
						<li>
							<a href="<?php echo $site['social']['discord']; ?>" target="blank">Discord</a>
						</li>
						<li>
							<a href=/news/index/blog-fullwidth.php class="lang"key="TNotice2">New</a>
						</li>
					</ul>
